...
@LearningRateScheduler.register("slanted_triangular_float_num_steps")
class SlantedTriangularFloatNumSteps(LearningRateScheduler):
    """
    ...
    def __init__(
        ...
        optimizer: torch.optim.Optimizer,
        num_epochs: int,
        num_steps_per_epoch: Union[Optional[int], Optional[float]] = None,
        cut_frac: float = 0.1,
        ratio: int = 32,
        last_epoch: int = -1,
