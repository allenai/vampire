...
class TestTextClassificationJsonReader(VAETestCase):
    ...
    def test_read_from_file(self):
        ...
        instance1 = {"tokens": ['...', 'And', 'I', 'never', 'thought', 'a', 'movie', 'deserved', 'to', 'be', 'awarded', 'a', '1', '!', 'But', 'this', 'one', 'is', 'honestly', 'the', 'worst', 'movie', 'I', "'ve", 'ever', 'watched', '.', 'My', 'wife', 'picked', 'it', 'up', 'because', 'of', 'the', 'cast', ',', 'but', 'the', 'storyline', 'right', 'since', 'the', 'DVD', 'box', 'seemed', 'quite', 'predictable', '.', 'It', 'is', 'not', 'a', 'mystery', ',', 'nor', 'a', 'juvenile', '-', 'catching', 'film', '.', 'It', 'does', 'not', 'include', 'any', 'sensuality', ',', 'if', 'that', "'s", 'what', 'the', 'title', 'could', 'remotely', 'have', 'suggest', 'any', 'of', 'you', '.', 'This', 'is', 'just', 'a', 'total', 'no', '-', 'no', '.', 'Do', "n't", 'waste', 'your', 'time', 'or', 'money', 'unless', 'you', 'feel', 'like', 'watching', 'a', 'bunch', 'of', 'youngsters', 'in', 'a', 'as', '-', 'grown', '-', 'up', 'kind', 'of', 'Gothic', 'setting', ',', 'where', 'a', 'killer', 'is', 'going', 'after', 'them', '.', 'Nothing', 'new', ',', 'nothing', 'interesting', ',', 'nothing', 'worth', 'watching', '.', 'Max', 'Makowski', 'makes', 'the', 'worst', 'of', 'Nick', 'Stahl', '.'],
                     "label": "neg"}
        instance2 = {"tokens": ['The', 'fight', 'scenes', 'were', 'great', '.', 'Loved', 'the', 'old', 'and', 'newer', 'cylons', 'and', 'how', 'they', 'painted', 'the', 'ones', 'on', 'their', 'side', '.', 'It', 'was', 'the', 'ending', 'that', 'I', 'hated', '.', 'I', 'was', 'disappointed', 'that', 'it', 'was', 'earth', 'but', '150k', 'years', 'back', '.', 'But', 'to', 'travel', 'all', 'that', 'way', 'just', 'to', 'start', 'over', '?', 'Are', 'you', 'kidding', 'me', '?', '38k', 'people', 'that', 'fought', 'for', 'their', 'very', 'existence', 'and', 'once', 'they', 'get', 'to', 'paradise', ',', 'they', 'abandon', 'technology', '?', 'No', 'way', '.', 'Sure', 'they', 'were', 'eating', 'paper', 'and', 'rationing', 'food', ',', 'but', 'that', 'is', 'over', '.', 'They', 'can', 'live', 'like', 'humans', 'again', '.', 'They', 'only', 'have', 'one', 'good', 'doctor', '.', 'What', 'are', 'they', 'going', 'to', 'do', 'when', 'someone', 'has', 'a', 'tooth', 'ache', 'never', 'mind', 'giving', 'birth', '...', 'yea', 'right', '.', 'No', 'one', 'would', 'have', 'made', 'that', 'choice', '.'],
                     "label": "pos"}
        instance3 = {"tokens": ['The', 'only', 'way', 'this', 'is', 'a', 'family', 'drama', 'is', 'if', 'parents', 'explain', 'everything', 'wrong', 'with', 'its', 'message.<br', '/><br', '/>SPOILER', ':', 'they', 'feed', 'a', 'deer', 'for', 'a', 'year', 'and', 'then', 'kill', 'it', 'for', 'eating', 'their', 'food', 'after', 'killing', 'its', 'mother', 'and', 'at', 'first', 'pontificating', 'about', 'taking', 'responsibility', 'for', 'their', 'actions', '.', 'They', 'blame', 'bears', 'and', 'deer', 'for', '"', 'misbehaving', '"', 'by', 'eating', 'while', 'they', 'take', 'no', 'responsibility', 'to', 'use', 'adequate', 'locks', 'and', 'fences', 'or', 'even', 'learn', 'to', 'shoot', 'instead', 'of', 'twice', 'maiming', 'animals', 'and', 'letting', 'them', 'linger', '.'],
                     "label": "neg"}
