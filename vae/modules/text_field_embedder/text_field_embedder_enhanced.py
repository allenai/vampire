...
@TextFieldEmbedder.register("enhanced")
class BasicTextFieldEmbedderPlusPlus(TextFieldEmbedder):
    """
    ...
    def __init__(self,
        ...
        super(BasicTextFieldEmbedderPlusPlus, self).__init__()
    ...
    def forward(self, text_field_input: Dict[str, torch.Tensor], num_wrapping_dims: int = 0) -> torch.Tensor:
        ...
        for key in keys:
            ...
            output[key] = token_vectors
        return output, torch.cat(embedded_representations, dim=-1)
