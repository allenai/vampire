...
CLASSIFIER = {
        ...
        "SEQUENCE_LENGTH": 400,
        "TRAIN_PATH": os.environ["DATA_DIR"] + "/tokenized/train.jsonl",
        "DEV_PATH":  os.environ["DATA_DIR"] + "/tokenized/dev.jsonl",
        "TEST_PATH":  os.environ["DATA_DIR"] + "/tokenized/test.jsonl",
...
MULTIPROCESS_VAMPIRE = {
        ...
        "LINEAR_SCALING": 1000,
        "VAE_HIDDEN_DIM": 81,
        "TRAIN_PATH": os.environ["DATA_DIR"] + "/preprocessed_shards_1/*",
        "NUM_WORKERS": 1,
        "DEV_PATH": os.environ["DATA_DIR"] + "/dev.npz",
        "REFERENCE_COUNTS": os.environ["DATA_DIR"] + "/reference/ref.npz",
        "REFERENCE_VOCAB": os.environ["DATA_DIR"] + "/reference/ref.vocab.json",
...
ENVIRONMENTS = {
        "VAMPIRE": VAMPIRE,
        "MULTIPROCESS_VAMPIRE": MULTIPROCESS_VAMPIRE,
        "CLASSIFIER": CLASSIFIER,
        "VAMPIRE_WORDVEC": VAMPIRE_WORDVEC
}
