...
UNSUPERVISED_VAE_SEARCH = {
        ...
        "TRAIN_PATH": DATASETS['authorship']['train'],
        "UNLABELED_DATA_PATH": DATASETS['authorship']['unlabeled'],
        "DEV_PATH": DATASETS['authorship']['dev'],
        "REFERENCE_COUNTS": DATASETS['authorship']['reference_counts'],
        "REFERENCE_VOCAB": DATASETS['authorship']['reference_vocabulary'],
        "STOPWORDS_PATH": DATASETS['authorship']['stopword_path'],
