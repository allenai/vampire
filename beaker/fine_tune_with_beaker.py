...
def main(param_file: str, model_archive: str, args: argparse.Namespace):
...
if __name__ == "__main__":
    ...
    parser.add_argument('--model_archive', '-m', type=str)

    args = parser.parse_args()


    main(args.param_file, args.model_archive, args)
